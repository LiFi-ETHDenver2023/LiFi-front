      ...
      <StickyArea ref={stickyAreadRef}>
        ...
        <StakingInfo>
          ...
          <div className="typo-description">
            <span style={{ fontWeight: 700 }}>{(challenge.stakingAPT * 5) / 2} MATIC</span> refund
      ...
      {tabIndex === DETAIL_INDEX ? (
        <div>
          <ChallengeInfo>
            ...
            <div className="typo-title">~MAR 05, 2023 / IRL</div>
            <div className="typo-recruit-title">recruitment period</div>
            <div className="typo-recruit-sub">2023. 03. 02. ~ 2023. 03. 05</div>
          </ChallengeInfo>
          <LeaderInfo>
